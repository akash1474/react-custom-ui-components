...
//const test=[{title:"Google",val:"g"},{title:"Amazon",val:"a"},{title:"SpaceX",val:"s"}];
...
export const DropDown:React.FC<Props>=({title="Select",children,onChange})=>{

    const [state,setState]=React.useState<string>(title)

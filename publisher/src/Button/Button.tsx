...
const Button: React.FC<ButtonProps> = ({
	...
	const selectedColor:string=type?types[type]:color?color:types.default;
	...
	return (
		<div onClick={onClick} className={disabled?`${classes.button} ${classes.disabled}`:classes.button}>
